...
namespace UtilityClasses
    ...
    public class ByteArrayBuilder : IDisposable
        ...
        /// <summary>
        /// Adds a class which self describes into the builder.
        /// </summary>
        /// <param name="instance">IByteArrayBuildable class instance</param>
        public void Append(IByteArrayBuildable instance)
            {
        ...
        /// </summary>
        /// <param name="instance">IByteArrayBuildable class instance</param>
        public void GetBuildable(IByteArrayBuildable instance)
            {
